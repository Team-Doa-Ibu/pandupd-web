...
export default function ScreeningResultPage() {
  // Contoh data hasil skrining dengan confidence score
  const spiralResult = {
    isDetected: true,
    imageSrc: "/images/spiral-test.jpg",
    confidenceScore: 87 // Contoh nilai confidence score
  };
  
  const voiceResult = {
    isDetected: false,
    imageSrc: "/images/voice-analysis.jpg",
    confidenceScore: 32 // Contoh nilai confidence score
  };
      ...
      <div className="container mx-auto px-4 py-20 mt-10">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          <SpiralScreeningCard
            ...
            confidenceScore={spiralResult.confidenceScore}
          />
