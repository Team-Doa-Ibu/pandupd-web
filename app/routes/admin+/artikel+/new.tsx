...
export default function AdminArtikelNew() {
    ...
    try {
      ...
      if (error) {
        showAlertMessage(
          "warning",
          "Fallback",
          "Tabel articles belum tersedia. Silakan buat tabel di Supabase atau gunakan data statis.",
        );
        setSaving(false);
        return;
      }
      showAlertMessage("success", "Berhasil", "Artikel berhasil dibuat", () =>
  ...
  return (
    <ProtectedRoute adminOnly>
      <AdminLayout
        title="Artikel Baru"
        subtitle="Buat artikel informasi Parkinson"
      >
        <Alert
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
          ...
          <div className="space-y-4">
            ...
            <div className="pt-2">
              ...
              >
                <IconDeviceFloppy size={16} /> Simpan Artikel
              </button>
            </div>
          </div>
        </div>
